...
UNIQUE KEY `id_UNIQUE` (`id`), UNIQUE KEY `quote_UNIQUE` (`quote`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=latin1; /*!40101 SET character_set_client = @saved_cs_client */;
--
...
/*!40000 ALTER TABLE `quotes` ENABLE KEYS */; UNLOCK TABLES;
...
-- Dump completed on 2018-11-22 12:36:30